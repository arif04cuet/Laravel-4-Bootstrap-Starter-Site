        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li
                    {{ (Request::is('admin/contact/index') ? ' class="active"' : '') }}><a
                        href="{{{ URL::to('admin/contacts') }}}"><span class="glyphicon glyphicon-search"></span> Lookup</a></li>
                    <li
                    {{ (Request::is('admin/contacts/create') ? ' class="active"' : '') }}><a
                        href="{{{ URL::to('admin/contacts/create') }}}"><span class="glyphicon glyphicon-user"></span>
                        Sign Up</a></li>
                </ul>
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>-->
                            <li><a href="{{{ URL::to('user/logout') }}}"><span class="glyphicon glyphicon-share"></span>
                                    Logout</a></li>
                        </ul>
                    </li>
                </ul>
